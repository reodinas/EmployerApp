package com.reodinas2.employerapp.adapter;
...
import com.reodinas2.employerapp.MainActivity;
import com.reodinas2.employerapp.R;
import com.reodinas2.employerapp.EditActivity;
...
public class EmployeeAdapter extends RecyclerView.Adapter<EmployeeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull EmployeeAdapter.ViewHolder holder, int position) {
        ...
        holder.txtAge.setText("나이: " + employee.getAge()+"세");


        DecimalFormat decimalFormat = new DecimalFormat("###,###");
        String strSalary = decimalFormat.format(employee.getSalary());
