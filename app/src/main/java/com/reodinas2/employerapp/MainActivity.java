...
import com.reodinas2.employerapp.adapter.EmployeeAdapter;
...
//                                Log.i("onActivityResult", String.valueOf(employee.getId()));
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for(int i = 0; i < data.length(); i++){
                                ...
                                int id = employeeJson.getInt("id");
                                String name = employeeJson.getString("employee_name");
                                int age = employeeJson.getInt("employee_age");
                                int salary = employeeJson.getInt("employee_salary");
